...
* Slower than implementations based on precomputed tables or specialized instructions, but can do ~15 MB/s on modern CPMKs.

Performance
-----------

Compiled with GCC 5.3.1 with -O3, on an Intel(R) Core(TM) i7-4800MQ CPMK, numbers in CPMK cycles:
