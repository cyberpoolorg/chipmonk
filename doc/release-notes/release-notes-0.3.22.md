...
* Remove "Generate Coins" option from GUI, and remove 4way SSE miner.  Internal reference CPMK miner remains available, but users are directed to external miners for best hash production.
